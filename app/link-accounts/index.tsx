...
const s = StyleSheet.create({
  ...
  bankName: { fontSize: 13, fontWeight: "600", color: colors.cream },
  bankStatus: { fontSize: 10, fontWeight: "600", color: colors.positive, marginTop: 2 },
  bankBalance: { fontSize: 13, fontWeight: "700", color: colors.cream },
  addRow: {
    flexDirection: "row",
    alignItems: "center",
    padding: 12,
  ...
  addTitle: { fontSize: 13, fontWeight: "600", color: colors.cream },
  addSub: { fontSize: 10, color: colors.textSecondary, marginTop: 2 },
  addBadge: {
    paddingHorizontal: 10,
    paddingVertical: 6,
    backgroundColor: "rgba(22,40,68,0.3)",
    borderRadius: 8,
  },
  addBadgeText: { fontSize: 11, fontWeight: "700", color: colors.yellow },
  trustText: {
    fontSize: 10,
    color: colors.textSecondary,
    textAlign: "center",
